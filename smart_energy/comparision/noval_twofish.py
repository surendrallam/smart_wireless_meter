'''
Author: Ashok 
Project: Twofish Data Encryption for Wireless Smart Energy Meter
Description: This program is for data encryption of wireless smart energy meter using Twofish algorithm.
'''
import imp
import sys, time
...
byte_key=bytes(sys.argv[1], 'utf-8')
print(byte_key)
...
byte_message=bytes(sys.argv[2], 'utf-8')
print(byte_message)
twofish_encrypt = encrypted_key.encrypt(byte_message)

noval_encrypt=encrypted_key.encrypt(twofish_encrypt)
